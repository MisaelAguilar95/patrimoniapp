	...
	private function valida_menu(){
		...
		switch (true) {
			...
			case strpos($url, 'bitacora') !== false:
				...
				$descripcion = 'Módulo para ver el registro de todos los movimientos';
			break; */
			...
			break; */
			default:
				$titulo_m = "Listado de Inmuebles";
				$fa_icon= 'fa fa-file';
				$descripcion = 'Agregar información adicional a cada inmueble';
				$inicio_m = 'active';
			break;
		}
		...
		<li>
			<li class="'.$inicio_m.'">
				<a href="'.base_url().'" title="Listado de Inmuebles" >
					<i class="fal fa-file"></i>
					<span class="nav-link-text">Listado de Inmuebles</span>
				</a>
			</li>
			<li class=" open'.$reportes_m.'">
