                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9">
                                                <img style="width:150px" src="<?=base_url()?>frontend/images/conaforlogo.jpg" alt="SmartAdmin WebApp" aria-roledescription="logo">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col hidden-sm-down">
                                                <h3 class="fs-xxl fw-500 mt-4 text-white">
                                                    Sistema de Administración y Control Patrimonial
                                                    <small class="h3 fw-300 mt-3 mb-5 text-white opacity-60">
                                                        Nuevo sistema para la administración, control y reporteo  Patrimonial.
                                                    </small>
                                                </h3>
                                            </div>
                                        </div>
